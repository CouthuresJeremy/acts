...
class CsvSimSeedWriter final : public WriterT<SimSeedContainer> {
 public:
  struct Config {
  ...
  CsvSimSeedWriter(const Config& config, Acts::Logging::Level level);

  /// Virtual destructor
  ~CsvSimSeedWriter() final override;
 ...
 protected:
  ...
  ProcessCode writeT(const AlgorithmContext& ctx,
                     const SimSeedContainer& simSeed) final override;
